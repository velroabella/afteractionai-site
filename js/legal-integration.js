...
(function () {
  ...
  const CONTENT_PATTERNS = [
    ...
    /* Financial / administrative form patterns (strict — no .* wildcards)
       ORDER MATTERS: va-loan-readiness-checklist MUST precede credit-dispute
       and budget-financial because VA loan responses reference those forms
       by name, which would trigger false matches via first-match-wins. */
